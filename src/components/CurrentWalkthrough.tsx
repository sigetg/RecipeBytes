  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const instructionsRes = await axios.get<AnalyzedInstruction[]>(INSTRUCTIONS_API_URL, { //what does this return?
        ...
        const ingredientsRes = await axios.get<RecipeInformation>(INGREDIENTS_API_URL, {
          params: { apiKey: process.env.REACT_APP_SPOONACULAR_API_KEY },
        });
